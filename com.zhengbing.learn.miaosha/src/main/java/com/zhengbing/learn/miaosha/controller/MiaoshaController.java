...
/** Created by zhengbing on 2019/5/31. Since Version 1.0 */
@Controller
...
public class MiaoshaController implements InitializingBean {
  ...
  @Autowired MiaoshaOrderService miaoshaOrderService;
  ...
  @ResponseBody
  public Result<Integer> do_miaosha(
      Model model,
      MiaoshaUser user,
    ...
    MiaoshaOrder miaoshaOrder =
        miaoshaOrderService.getMiaoshaOrderByUserIdGoodsId(user.getId(), goodsId);
